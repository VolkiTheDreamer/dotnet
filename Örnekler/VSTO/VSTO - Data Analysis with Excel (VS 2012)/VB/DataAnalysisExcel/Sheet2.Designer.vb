...
Partial Public NotInheritable Class Sheet2
    ...
    Private Sub InitializeControls()
        Me.Chart_1 = Globals.Factory.CreateChart(Nothing, Nothing, "Sheet2:Chart 1", "Chart_1", Me)
        Me.History = Globals.Factory.CreateListObject(Nothing, Nothing, "Sheet2:History", "History", Me)
        Me.FlavorNamedRange = Globals.Factory.CreateNamedRange(Nothing, Nothing, "FlavorNamedRange", "FlavorNamedRange", Me)
        Me.Sheet2_TitleLabel = Globals.Factory.CreateNamedRange(Nothing, Nothing, "Sheet2!TitleLabel", "Sheet2_TitleLabel", Me)
        Me.IceCreamLabel = Globals.Factory.CreateNamedRange(Nothing, Nothing, "IceCreamLabel", "IceCreamLabel", Me)
    End Sub
