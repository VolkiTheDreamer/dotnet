...
Partial Class frmBatchMail
    ...
    Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frmBatchMail))
        ...
        Me.ToolTip1.SetToolTip(Me.rbToUnits, resources.GetString("rbToUnits.ToolTip"))
        ...
        Me.ToolTip1.SetToolTip(Me.rbToTodaki, "To kolonunda belirtilen sicil/siciller veya mail adreslerine gönderim yapılır")
        ...
        Me.ToolTip1.SetToolTip(Me.rbFromOther, "Biriminiz veya amiriniz adına mail atma yetkiniz varsa buraya yazabilrisiniz.")
        ...
        Me.ToolTip1.SetToolTip(Me.Label16, "Parametrik giden eklerde dosya ayracı olarak ne kullanılmışsa onu seçin")
        '
        'Label15
        '
        ...
        Me.ToolTip1.SetToolTip(Me.Label15, "Parametrik giden eklerin dışında tüm alıcılara ulaşmasını istediğniz" & Global.Microsoft.VisualBasic.ChrW(13) & Global.Microsoft.VisualBasic.ChrW(10) & "bağımsız ek" & _
        "leri buradan ekleyebilirsiniz.")
        '
        'Button3
        '
        ...
        Me.ToolTip1.SetToolTip(Me.cbEkBelirtec, "Dosyalar neye göre bölünmüşse o seçilir.")
        '
        'btnIptal
        '
